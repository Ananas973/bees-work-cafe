            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-stats">
                        ...
                        <div class="card-content">
                            <p class="category">Catégorie / Article</p>
                        ...
                        <div class="card-footer">
                            <div class="stats">
                                ...
                                <a href="#pablo">Total Catégories et Articles</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-stats">
                        ...
                        <div class="card-content">
                            <p class="category">Réservation</p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-stats">
                        ...
                        <div class="card-footer">
                            <div class="stats">
                                <i class="material-icons">update</i> Mise à jour récente
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                @foreach($reservations as $key=>$reservation)
                                    <tr>
                                        ...
                                        <th>
                                            ...
                                            @else
                                                <span class="label label-danger">En attente de confirmation</span>
                                            @endif
                                        ...
                                        <td>
                                            @if($reservation->status == false)
                                                ...
                                                <button type="button" class="btn btn-info btn-sm" onclick="if(confirm('Are you verify this request by phone?')){
                                                        ...
                                                        event.preventDefault();
                                                        }"><i class="material-icons">Fait</i></button>
                                            @endif
